...
extension CalculateScaledWidthIfNecessary on SimpleDrawingTool {
  double getScaledWidthIfNecessary(BoardState state) => shouldScale ? width / state.scaleFactor : width;
}
